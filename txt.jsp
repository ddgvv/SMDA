...
<tr>
    <td colspan="18"><b>Mrs. <%= request.getParameter("name")%> <p class="indent"><%= request.getParameter("address")%>, Puducherry-605009 </p></b></td>
</tr>
<tr>
...
<tr>
	...
	Rupees in words:<%= request.getParameter("riw")%></td>
